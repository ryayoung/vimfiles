...
argglobal
%argdel
edit \Users\ryany\web-programming\misc\page-switcher\style.css
...
silent! normal! zE
let &fdl = &fdl
let s:l = 78 - ((14 * winheight(0) + 9) / 18)
...
wincmd w
argglobal
if bufexists("\Users\ryany\web-programming\misc\page-switcher\index.html") | buffer \Users\ryany\web-programming\misc\page-switcher\index.html | else | edit \Users\ryany\web-programming\misc\page-switcher\index.html | endif
balt \Users\ryany\web-programming\misc\page-switcher\index.html
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <C-K>m <Plug>(emmet-merge-lines)
inoremap <buffer> <Plug>(emmet-merge-lines) =emmet#util#closePopup()=emmet#mergeLines()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((12 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
exe '3resize ' . ((&lines * 18 + 29) / 58)
tabnext 1
badd +0 \Users\ryany\web-programming\misc\page-switcher\style.css
