...
edit SQL_Labs.sql
argglobal
balt SQL1_Intro_Entering_Information.sql
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 1 - ((0 * winheight(0) + 60) / 120)
...
normal! 0
tabnext 1
badd +1 SQL1_Intro_Entering_Information.sql
badd +1 YouTry.sql
badd +1 SQL_Labs.sql
badd +1 SQL2_Extracting_Information.sql
badd +1 SQL5_Queries_Within_Queries.sql
badd +1 SQL3_Selecting_Data_Different_Tables.sql
badd +1 SQL4_Grouping_Aggregating_Data.sql
